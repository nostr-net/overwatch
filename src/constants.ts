...
const FORCED_RELAY = import.meta.env.VITE_FORCED_RELAY

export const DEFAULT_FAVORITE_RELAYS = FORCED_RELAY
  ? [FORCED_RELAY]
  : [
      'wss://nostr.wine/',
...
export const BIG_RELAY_URLS = FORCED_RELAY
  ? [FORCED_RELAY]
  : [
      'wss://relay.damus.io/',
...
export const SEARCHABLE_RELAY_URLS = FORCED_RELAY
  ? [FORCED_RELAY]
  : ['wss://relay.nostr.band/', 'wss://search.nos.today/']

export const LOCKED_RELAY = FORCED_RELAY || null
